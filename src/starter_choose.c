...
#define GRASS_STARTER (IS_FRLG ? SPECIES_BULBASAUR  : SPECIES_KUBFU)
#define FIRE_STARTER  (IS_FRLG ? SPECIES_CHARMANDER : SPECIES_WICKRAB)
#define WATER_STARTER (IS_FRLG ? SPECIES_SQUIRTLE   : SPECIES_MUDKIP_MIREGLEN )
