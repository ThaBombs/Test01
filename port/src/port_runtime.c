...
static uint8_t GlyphRow(char ch, int row)
{
    ...
    static const uint8_t glyphD[7] = {30, 17, 17, 17, 17, 17, 30};
    static const uint8_t glyphE[7] = {31, 16, 16, 30, 16, 16, 31};
    static const uint8_t glyphF[7] = {31, 16, 16, 30, 16, 16, 16};
    static const uint8_t glyphG[7] = {14, 17, 16, 23, 17, 17, 14};
    static const uint8_t glyphH[7] = {17, 17, 17, 31, 17, 17, 17};
    static const uint8_t glyphI[7] = {31, 4, 4, 4, 4, 4, 31};
    static const uint8_t glyphJ[7] = {7, 2, 2, 2, 18, 18, 12};
    static const uint8_t glyphK[7] = {17, 18, 20, 24, 20, 18, 17};
    static const uint8_t glyphL[7] = {16, 16, 16, 16, 16, 16, 31};
    static const uint8_t glyphM[7] = {17, 27, 21, 21, 17, 17, 17};
    static const uint8_t glyphN[7] = {17, 25, 21, 19, 17, 17, 17};
    static const uint8_t glyphO[7] = {14, 17, 17, 17, 17, 17, 14};
    static const uint8_t glyphP[7] = {30, 17, 17, 30, 16, 16, 16};
    static const uint8_t glyphQ[7] = {14, 17, 17, 17, 21, 18, 13};
    ...
    static const uint8_t glyphU[7] = {17, 17, 17, 17, 17, 17, 14};
    static const uint8_t glyphV[7] = {17, 17, 17, 17, 17, 10, 4};
    static const uint8_t glyphW[7] = {17, 17, 17, 21, 21, 21, 10};
    static const uint8_t glyphX[7] = {17, 17, 10, 4, 10, 17, 17};
    static const uint8_t glyphY[7] = {17, 17, 10, 4, 4, 4, 4};
    static const uint8_t glyphZ[7] = {31, 1, 2, 4, 8, 16, 31};
    static const uint8_t glyph0[7] = {14, 17, 19, 21, 25, 17, 14};
    static const uint8_t glyph1[7] = {4, 12, 4, 4, 4, 4, 14};
    ...
    static const uint8_t glyph5[7] = {31, 16, 16, 30, 1, 1, 30};
    static const uint8_t glyph6[7] = {14, 16, 16, 30, 17, 17, 14};
    static const uint8_t glyph7[7] = {31, 1, 2, 4, 8, 8, 8};
    static const uint8_t glyph8[7] = {14, 17, 17, 14, 17, 17, 14};
    static const uint8_t glyph9[7] = {14, 17, 17, 15, 1, 1, 14};
    ...
    case 'U': glyph = glyphU; break;
    case 'V': glyph = glyphV; break;
    case 'W': glyph = glyphW; break;
    case 'X': glyph = glyphX; break;
    case 'Y': glyph = glyphY; break;
    case 'Z': glyph = glyphZ; break;
    case '0': glyph = glyph0; break;
    case '1': glyph = glyph1; break;
    case '2': glyph = glyph2; break;
    case '3': glyph = glyph3; break;
    case '4': glyph = glyph4; break;
    case '5': glyph = glyph5; break;
    case '6': glyph = glyph6; break;
    case '7': glyph = glyph7; break;
    case '8': glyph = glyph8; break;
    case '9': glyph = glyph9; break;
    default: return 0;
    }
